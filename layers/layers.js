...
//ol.proj.get("EPSG:4326").setExtent([63.266898, 5.911952, 97.502627, 32.498948]);
var wms_layers = [];
...
var format_Buffer50Km_8 = new ol.format.GeoJSON();
var features_Buffer50Km_8 = format_Buffer50Km_8.readFeatures(json_Buffer50Km_8, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_Buffer50Km_8 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Buffer50Km_8.addFeatures(features_Buffer50Km_8);
var lyr_Buffer50Km_8 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Buffer50Km_8, 
                style: style_Buffer50Km_8,
                popuplayertitle: "Buffer 50 Km",
                interactive: true,
                    title: '<img src="styles/legend/Buffer50Km_8.png" /> Buffer 50 Km'
                });
...
var format_PaperMills_TOP_20_Rice_11 = new ol.format.GeoJSON();
var features_PaperMills_TOP_20_Rice_11 = format_PaperMills_TOP_20_Rice_11.readFeatures(json_PaperMills_TOP_20_Rice_11, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_PaperMills_TOP_20_Rice_11 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PaperMills_TOP_20_Rice_11.addFeatures(features_PaperMills_TOP_20_Rice_11);
var lyr_PaperMills_TOP_20_Rice_11 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PaperMills_TOP_20_Rice_11, 
                style: style_PaperMills_TOP_20_Rice_11,
                popuplayertitle: "Paper Mills_TOP_20_Rice",
                interactive: true,
                    title: '<img src="styles/legend/PaperMills_TOP_20_Rice_11.png" /> Paper Mills_TOP_20_Rice'
                });
var group_PaperMills = new ol.layer.Group({
                                layers: [lyr_PaperMills_10,lyr_PaperMills_TOP_20_Rice_11,],
                                fold: "open",
                                title: "Paper Mills"});
...
lyr_ESRIPhysical_0.setVisible(true);lyr_BaseMapGrey_1.setVisible(true);lyr_GoogleSatellite_2.setVisible(true);lyr_Belowthreshold1075kTons_3.setVisible(true);lyr_Rice75kTons_4.setVisible(true);lyr_Rice_5.setVisible(true);lyr_Wheat75kTons_6.setVisible(true);lyr_Wheat_7.setVisible(true);lyr_Buffer50Km_8.setVisible(false);lyr_IndiaBoundary_9.setVisible(true);lyr_PaperMills_10.setVisible(true);lyr_PaperMills_TOP_20_Rice_11.setVisible(true);
var layersList = [group_Basemap,group_Feedstock,lyr_Buffer50Km_8,lyr_IndiaBoundary_9,group_PaperMills];
...
lyr_Buffer50Km_8.set('fieldAliases', {'Site Code': 'Site Code', 'Company Na': 'Company Na', 'Site Name': 'Site Name', 'Site City': 'Site City', 'Site State': 'Site State', 'Site Count': 'Site Count', 'My Site In': 'My Site In', 'My Site _1': 'My Site _1', });
...
lyr_Buffer50Km_8.set('fieldLabels', {'Site Code': 'inline label - always visible', 'Company Na': 'inline label - always visible', 'Site Name': 'hidden field', 'Site City': 'hidden field', 'Site State': 'hidden field', 'Site Count': 'inline label - always visible', 'My Site In': 'hidden field', 'My Site _1': 'hidden field', });
